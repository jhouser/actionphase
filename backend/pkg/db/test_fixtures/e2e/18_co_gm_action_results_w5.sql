-- E2E Test Fixture for Co-GM Action Results (Worker 5)
-- Game ID: 349 (worker 5 offset: 50000 → game 349)
...
DECLARE
  ...
  worker_game_id_offset INTEGER := 50000;
BEGIN
  ...
  player1_id   := get_worker_user_id('TestPlayer1', 5);
...
SELECT 'E2E Co-GM Action Results fixture (worker 5) created successfully!' AS message;
