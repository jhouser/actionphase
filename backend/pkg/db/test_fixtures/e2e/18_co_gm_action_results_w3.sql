-- E2E Test Fixture for Co-GM Action Results (Worker 3)
-- Game ID: 349 (worker 3 offset: 30000 → game 349)
...
BEGIN
  ...
  audience2_id := get_worker_user_id('TestAudience2', 3);
  player1_id   := get_worker_user_id('TestPlayer1', 3);
...
SELECT 'E2E Co-GM Action Results fixture (worker 3) created successfully!' AS message;
